...
export function AdminHeader({
  ...
  return (
    <div className="admin-header sticky top-0 z-50 backdrop-blur-2xl border-b border-gray-700/50 shadow-2xl">
      <div className="container mx-auto px-6 py-4">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              onClick={onLogout}
              className="btn-glass text-gray-300 px-4 py-2 rounded-lg text-sm font-medium hover:text-white transition-colors flex items-center gap-2"
            >
              {ClimateIcons.logout}
              <span>Logout</span>
            </button>
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 panel-glass border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/50 transition-all duration-200"
          />
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="btn-glass text-gray-400 hover:text-white px-3 py-1.5 rounded-lg text-xs transition-all duration-200 flex items-center gap-1 ml-2"
              >
                {ClimateIcons.cancel}
